...
CONF_AVAILABLE_DRAWABLES = [DRAWABLE_CLEANED_AREA, DRAWABLE_CHARGER, DRAWABLE_GOTO_PATH,
                            ...
                            DRAWABLE_OBSTACLES, DRAWABLE_OBSTACLES_WITH_PHOTO, DRAWABLE_PREDICTED_PATH, DRAWABLE_ROOM_NAMES,
...
CONF_AVAILABLE_COLORS = [COLOR_CARPETS, COLOR_CHARGER, COLOR_CHARGER_OUTLINE, COLOR_CLEANED_AREA, COLOR_GOTO_PATH,
                         ...
                         COLOR_SCAN, COLOR_UNKNOWN, COLOR_VIRTUAL_WALLS, COLOR_ZONES, COLOR_ZONES_OUTLINE, COLOR_OBSTACLE_OUTLINE]
