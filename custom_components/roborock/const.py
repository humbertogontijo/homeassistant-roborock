...
CONF_AVAILABLE_DRAWABLES = [DRAWABLE_CLEANED_AREA, DRAWABLE_CHARGER, DRAWABLE_GOTO_PATH,
                            DRAWABLE_IGNORED_OBSTACLES, DRAWABLE_IGNORED_OBSTACLES_WITH_PHOTO, DRAWABLE_MOP_PATH,
                            DRAWABLE_NO_CARPET_AREAS, DRAWABLE_NO_GO_AREAS, DRAWABLE_NO_MOPPING_AREAS, DRAWABLE_PATH,
                            DRAWABLE_OBSTACLES, DRAWABLE_OBSTACLES_WITH_PHOTO, DRAWABLE_PREDICTED_PATH,
                            DRAWABLE_ROOM_NAMES, DRAWABLE_VACUUM_POSITION, DRAWABLE_VIRTUAL_WALLS, DRAWABLE_ZONES]
...
CONF_AVAILABLE_COLORS = [
    COLOR_CARPETS, COLOR_CHARGER, COLOR_CHARGER_OUTLINE, COLOR_CLEANED_AREA, COLOR_GOTO_PATH, COLOR_GREY_WALL,
    COLOR_IGNORED_OBSTACLE, COLOR_IGNORED_OBSTACLE_WITH_PHOTO, COLOR_MAP_INSIDE, COLOR_MAP_OUTSIDE, COLOR_MAP_WALL,
    COLOR_MAP_WALL_V2, COLOR_MOP_PATH, COLOR_NEW_DISCOVERED_AREA, COLOR_NO_CARPET_ZONES, COLOR_NO_CARPET_ZONES_OUTLINE,
    COLOR_NO_GO_ZONES, COLOR_NO_GO_ZONES_OUTLINE, COLOR_NO_MOPPING_ZONES, COLOR_NO_MOPPING_ZONES_OUTLINE,
    COLOR_OBSTACLE, COLOR_OBSTACLE_WITH_PHOTO, COLOR_PATH, COLOR_PREDICTED_PATH, COLOR_ROBO, COLOR_ROBO_OUTLINE,
    COLOR_ROOM_NAMES, COLOR_SCAN,COLOR_UNKNOWN, COLOR_VIRTUAL_WALLS, COLOR_ZONES, COLOR_ZONES_OUTLINE, COLOR_OBSTACLE_OUTLINE
]
